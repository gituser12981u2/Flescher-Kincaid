from PyQt5.QtWidgets import (QApplication, QMainWindow, QPushButton, 
    QVBoxLayout, QWidget, QTextEdit, QLabel, QComboBox, QSpacerItem, QSizePolicy,
    QAction, QToolBar)
...
class MainWindow(QMainWindow):
    ...
    def create_toolbar(self):
        ...
        self.settings_action = QAction(QIcon('src/icons/settingsCog.png'), '', self)
    ...
    def init_settings(self):
        ...
        self.settings_menu = SettingsMenu(self.settings_manager, self.settings_window)
